...
},{}],"vartalk-api.ts":[function(require,module,exports) {
"use strict";
...
var UTTERANCES_API = 'https://api.vartalk.cn';
...
var _vartalkApi = require("./vartalk-api");
...
function getLoginUrl(redirect_uri) {
  return _vartalkApi.UTTERANCES_API + "/authorize?" + (0, _deparam.param)({
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          url = _vartalkApi.UTTERANCES_API + "/token";
          return [4, fetch(url, {
            method: 'POST',
            mode: 'cors',
            credentials: 'include'
...
},{"./vartalk-api":"vartalk-api.ts","./deparam":"deparam.ts"}],"page-attributes.ts":[function(require,module,exports) {
"use strict";
...
function createIssue(issueTerm, documentUrl, title, description, label) {
  var url = _vartalkApi.UTTERANCES_API + "/repos/" + owner + "/" + repo + "/issues" + (label ? "?label=" + encodeURIComponent(label) : '');
...
},{"./oauth":"oauth.ts","./encoding":"encoding.ts","./vartalk-api":"vartalk-api.ts"}],"time-ago.ts":[function(require,module,exports) {
"use strict";
...
var TimelineComponent = function () {
  function TimelineComponent(user, issue) {
    ...
    this.element.innerHTML = "\n      <h1 class=\"timeline-header\">\n        <a class=\"text-link\" target=\"_blank\"></a>\n        <em>\n          - powered by\n          <a class=\"text-link\" href=\"https://vartalk.cn\" target=\"_blank\">vartalk.cn</a>\n        </em>\n      </h1>";
...
function getRepoConfig() {
  if (!promise) {
    promise = (0, _github.loadJsonFile)('vartalk.json').then(function (data) {
...
},{}],"vartalk.ts":[function(require,module,exports) {
"use strict";
...
},{"./page-attributes":"page-attributes.ts","./github":"github.ts","./timeline-component":"timeline-component.ts","./new-comment-component":"new-comment-component.ts","./measure":"measure.ts","./theme":"theme.ts","./repo-config":"repo-config.ts","./oauth":"oauth.ts","./reactions":"reactions.ts"}]},{},["vartalk.ts"], null)
//# sourceMappingURL=/vartalk.58eb2af4.js.map